...
function FeatureContainer({ title, description }: FeatureContainerInterface) {
    return (
        <div className="w-full md:w-[calc(33%-16px)] h-[60svh] flex flex-col items-start justify-center gap-3 p-5 border border-zinc-300 rounded-xl bg-zinc-100">
    ...
    return (
        <div className="w-full h-auto flex flex-col items-center justify-start gap-15">
            ...
            <h1 className="text-4xl font-bold text-center md:max-w-lg">
                Select the itinerary, go to checkout, see all location on google map app
            </h1>

            <div className="w-full h-auto flex flex-wrap gap-x-6 gap-y-10">
                <FeatureContainer
